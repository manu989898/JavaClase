...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Podemos cambiar cualquier propiedad con los seters.
		...
		persona2.setApellidos("Martínez López");
		...
		if (persona1.tieneDni()) {
			System.out.println(persona1.getDni() + " tiene DNI");
		} else {
			System.out.println(persona1.getNombre() + " no tiene DNI");
		}

		if (persona2.tieneDni()) {
			System.out.println(persona2.getNombre() + " tiene DNI");
		} else {
			System.out.println(persona2.getNombre() + " no tiene DNI");
		}

		// Probamos el método anyoNacimiento().
		if (persona2.anyoNacimiento() == null) {
			System.out.println(persona2.getNombre() + " no tiene fecha de nacimiento.");
		} else {
			System.out.println(persona2.getNombre() + " nació el año " + persona2.anyoNacimiento() + ".");
		}
